...
关于*暂时性死区*的更多信息，查看这里 [MDN](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Statements/let#Temporal_dead_zone_and_errors_with_let)。

#### 重定义及屏蔽

使用 `var` 声明时，它不在乎你声明多少次；你只会得到 1 个。
...
* @param propertyKey: string | symbol - 被装饰类的属性名
*/
...
/**
* @param target: Object - 被装饰的类
* @param propertyKey: propertyKey: string | symbol - 方法名
